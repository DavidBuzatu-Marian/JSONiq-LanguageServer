...
describe("jsoniq-language-server", () => {
  ...
  test("can initialize and give semantic tokens", async () => {
    ...
    const expectedData = {
      data: [
        0, 0, 6, 2, 1, 0, 7, 1, 3, 8, 0, 1, 3, 3, 8, 0, 0, 3, 5, 4, 0, 4, 2, 10,
        0, 0, 3, 1, 3, 8, 0, 1, 3, 3, 8, 0, 0, 3, 5, 4, 0, 5, 1, 6, 8, 0, 2, 6,
        8, 1, 0, 7, 1, 10, 0, 0, 2, 1, 3, 8, 0, 1, 4, 3, 8, 0, 0, 4, 5, 4, 0, 6,
        8, 8, 1, 0, 9, 1, 10, 0, 0, 2, 5, 6, 18, 0, 5, 1, 14, 4, 0, 1, 1, 3, 8,
        0, 1, 5, 3, 8, 0, 0, 5, 5, 4, 0, 5, 1, 14, 1, 0, 2, 1, 6, 8,
      ],
    };
  ...
  test("semantic tokens with last token new variable", async () => {
    ...
    const expectedData = {
      data: [
        ...
        8, 1, 0, 7, 1, 10, 0, 0, 2, 1, 3, 8, 0, 1, 4, 3, 8, 0, 0, 4, 5, 4, 0, 6,
        8, 8, 1, 0, 9, 1, 10, 0, 0, 2, 5, 6, 18, 0, 5, 1, 14, 4, 0, 1, 1, 3, 8,
        0, 1, 5, 3, 8, 0, 0, 5, 5, 4, 0, 5, 1, 14, 1, 0, 2, 1, 6, 8, 1, 6, 1, 3,
        8,
      ],
    };
    const semanticTokens = await languageServer.request(
  ...
  test("semantic tokens with last token attribute", async () => {
    ...
    const expectedData = {
      data: [
        ...
        8, 1, 0, 7, 1, 10, 0, 0, 2, 1, 3, 8, 0, 1, 4, 3, 8, 0, 0, 4, 5, 4, 0, 6,
        8, 8, 1, 0, 9, 1, 10, 0, 0, 2, 5, 6, 18, 0, 5, 1, 14, 4, 0, 1, 1, 3, 8,
        0, 1, 5, 3, 8, 0, 0, 5, 5, 4, 0, 5, 1, 14, 1, 0, 2, 1, 6, 8, 1, 6, 1,
        14, 1,
      ],
    };
    const semanticTokens = await languageServer.request(
