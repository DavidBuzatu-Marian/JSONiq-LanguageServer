...
public class jsoniqLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "Kfor", "Klet", "Kwhere", "Kgroup", 
			...
			"Kbreak", "Kloop", "Kcontinue", "Kexit", "Kreturning", "Kwhile", "STRING", 
			"ESC", "UNICODE", "HEX", "ArgumentPlaceholder", "Plus", "Minus", "Times", 
